...
import com.jjy.utils.MenuHelper;
...
import static com.jjy.utils.MenuHelper.buildTree;
...
public class SysMenuServiceImpl implements SysMenuService {
    ...
    public List<SysMenuVo> findMenuByUserId() {
        ...
        //根据id查询可操作的菜单
        List<SysMenu> syMenuList = sysMenuMapper.findMenuByUserId(userId);

        //封装要求数据格式，返回
        List<SysMenu> sysMenuList = buildTree(syMenuList);
